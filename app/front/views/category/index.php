<?php
/**
 * /home/ubuntu/workspace/another.dev/app/front/runtime/giiant/a0a12d1bd32eaeeb8b2cff56d511aa22
 *
 * @package default
 */
 ...
 * @var front\models\CategorySearch $searchModel
 */
	...
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['post/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('app', 'Post'),
				],
