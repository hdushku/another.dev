...
<div class="giiant-crud category-view">
    ...
    <?php $this->beginBlock('front\models\Category'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	...
	['post/create', 'Post' => ['category_id' => $model->id]],
		...
		'columns' => [
			[
				...
				'urlCreator' => function ($action, $model, $key, $index) {
					...
					$params['Post'] = ['category_id' => $model->primaryKey()[0]];
					return $params;
				},
				'buttons'    => [
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->getType()->one()) {
						return Html::a($rel->title, ['type/view', 'id' => $rel->id, ], ['data-pjax' => 0]);
					} else {
						return '';
					}
				},
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['front\models\Category'],
				'active'  => true,
			],
			[
